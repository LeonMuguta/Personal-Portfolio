...
import Picture6 from "./Images/weather-app.PNG";
...
const collection = [
    {
        ...
        picture: Picture1,
        title: "Blog Project",
        description: "This application is a blogging site, allowing users to add & delete their own custom blog entries",
    ...
    },
    {
        ...
        picture: Picture2,
        title: "Link Sortener",
        description: "This application can by used by users to shorten long links, for cases where they may want to share a particular webpage. This was accomplished by using the bitly API.",
        stack: "Stack - HTML, CSS, JavaScript & ReactJS",
    ...
    },
    {
        ...
        description: "This is a simple to-do list app where users can input tasks they need to complete.",
